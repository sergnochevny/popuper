 ...
 */
class PopupsStyles extends Model
{
    const TABLE_NAME = 'popupsStyles';
    ...
    public function getByPopupId($popupId)
    {
        ...
        $cacheName = "popuper:::popupsStyles:getByPopupId:{$popupId}";
        ...
        if (is_null($result)) {
            ...
            Cache::instance()->set($cacheName, $result, Kohana::config('global/cache.popuper.popupsStyles'));
        }
